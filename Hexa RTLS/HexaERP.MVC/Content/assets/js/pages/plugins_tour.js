...
altair_tour = {
    init: function() {
        ...
        var enjoyhint_script_steps = [
            {
                "next #header_main": 'Wel Come to Pro ERP, In above header menu and with square menu<br>' +
                'click to square buttons you will get menues list.<br>' +
                'This is the main header and manue.<br>' +
            ...
            {
                "next #sidebar_main": "This is the primary sidebar. only active for Hexahash Super Admin<br>" +
