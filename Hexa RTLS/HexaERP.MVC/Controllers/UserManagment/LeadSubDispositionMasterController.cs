...
{
    public class LeadSubDispositionMasterController : Controller
    {
        //******************
        //Author: Mudassar I
        //Date: 06/02/2017
        ...
        [HttpGet]
        public JsonResult getLeadSubDisposition()
        {
            ...
            var ObjData = (from Dis in db.TC_LeadDisposition
                           ...
                           select new { Dis.TC_LeadDispositionId, Dis.Name }).ToList();
            //Convert List Data to The Json Array          
            return Json(ObjData, JsonRequestBehavior.AllowGet);
        }
        //Get All Department
        [HttpGet]
        public JsonResult getSubDisposition()
        {
        ...
        //Save New Departmnt
        [HttpGet]
        public string SaveSubDisposition(string DispositionName, int TC_InquiryTypeId)
        {
        ...
        //Get Dept By Id
        [HttpGet]
        public JsonResult getSubDispositionWithId(int ID)
        {
        ...
        //Update Department
        [HttpGet]
        public string UpdateSubDisposition(string DispositionName, int InqID, int ID)
        {
            string msg = "";
        ...
        //Delete Department
        [HttpGet]
        public string DeleteSubDisposition(int ID)
        {
            string msg = "";
