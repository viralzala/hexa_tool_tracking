...
{
    public class QualityReturnApproveSMTBinController : Controller
    {
        public static string UserName = string.Empty;

        // GET: QualityReturnApproveSMTBin
        ...
        [HttpGet]
        public async Task<ActionResult> GetQualityReturnApproveSMTBin()
        {
            // Initialization.
            ...
            try
            {
                ...
                {
                    var _product = await context.mSMTProducts.Where(f => f.IsQualityReturn == true).ToListAsync();
                    if (_product != null)
        ...
        [HttpPost]
        public ActionResult QualityReturnSMTBinRequest(string SMTProductIds, string Remark)
        {
            JsonResult result = new JsonResult();
            try
            {
                    ...
                    _SMTProductIds.ForEach(o =>
                    {
                        ...
                        if (_r != null)
                        {
                            if (_r.IsQualityReturn)
                            {
                                ...
                                _r.Remark = Remark;
                                _r.Status = JobStatus.QualityReturnRequestApproved;
                                _r.IsQualityReturn = false;
                                _r.IsPutaway = false;
                                _r.IsTakeaway = false;
                                _r.IsAssembly = false;
