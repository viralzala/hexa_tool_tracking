...
app.controller("EmployeeTrackSummaryCtrl", function ($timeout, $scope, $http) {
    initializeComponets();
    //
    ...
    $scope.GetEmployess = function () {
        ...
        $http({
            method: 'GET',
            url: '../EmployeeTrackSummary/GerEmployess',
    ...
    $scope.SaveFormCollData = function () {
        ...
        $http({
            method: 'POST',
            url: '../EmployeeTrackSummary/Create',
            data: _eData
        }).then(function successCallback(response) {
            //console.log(response.data);
            $scope.EmpColl = response.data.data;
            ...
            "aoColumns": [
                ...
                { "mData": "Zone" },
                {
                    ...
                    'mRender': function (data, type, full) {
                        return ((full.tDate == "" || full.tDate == null) ? 'N/A' : ConvertJsonDatetoanyformat(full.tDate, 'mm/dd/yyyy hh:mm:ss'));
                    }
                }
            ]
        });
    ...
    function initializeComponets() {
        ...
        $http({
            method: 'GET',
            url: '../EmployeeTrackSummary/getMasterData'
        }).then(function successCallback(response) {
            //console.log(response.data);
    ...
    function BindZone(_mSiteMasterId) {
        $http({
            method: 'GET',
            url: '../EmployeeTrackSummary/getZones',
    ...
    function BindSubZone(_mZoneId) {
        $http({
            method: 'GET',
            url: '../EmployeeTrackSummary/getSubZones',
            params: { id: _mZoneId }
        }).then(function successCallback(response) {
            $('#mFloorMasterId').kendoDropDownList({
                autoBind: true,
    ...
    function BindArea(_mFloorMasterId) {
        $http({
            method: 'GET',
            url: '../EmployeeTrackSummary/getArea',
