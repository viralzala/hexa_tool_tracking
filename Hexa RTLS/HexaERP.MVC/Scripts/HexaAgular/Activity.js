...
//
app.controller("ActivityCtrl", function ($timeout, $scope, $http, $window) {
    initializeComponets();
    ...
    $scope.SaveFormCollData = function () {
        if (angular.isUndefined($scope.Activity) || $scope.Activity === null) {
            toastr.error('Enter Activity');
            return false;
        }
