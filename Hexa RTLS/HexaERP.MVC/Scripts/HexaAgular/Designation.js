...
//
app.controller("DesignationCtrl", function ($timeout, $scope, $http, $window) {
    initializeComponets();
    ...
    $scope.SaveFormCollData = function () {
        if (angular.isUndefined($scope.Designation) || $scope.Designation === null) {
    ...
    $('body').on('click', '#EditIdata', function () {
        ...
        //console.log(isp.mDesignationId);
        $http({
            method: 'GET',
            url: '../Designation/Edit',
            params: { id: isp.mDesignationId }
        }).then(function successCallback(response) {
            //console.log(response.data);
            if (response.data.Flag == true) {
                $scope.Designation = response.data.Idata.Designation;
                $scope.mDesignationId = response.data.Idata.mDesignationId;
    ...
    $('body').on('click', '#Deletebtn', function () {
        ...
        if (answer) {
            ...
            //for row data
            var isp = table.row(row).data();
            DeleteRecord(isp.mDesignationId);
        }
    ...
    $scope.EditFormCollData = function () {
        if (angular.isUndefined($scope.Designation) || $scope.Designation === null || angular.isUndefined($scope.mDesignationId) || $scope.mDesignationId === null) {
