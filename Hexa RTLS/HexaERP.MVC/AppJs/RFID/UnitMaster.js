...
$(function () {
    ...
    $("#btnsave").click(function () {
        ...
        if (UnitName == "") {
            ...
            $.post("../UnitMaster/SaveData", { _UnitName: UnitName }, function (data) {
                console.log(data);
    ...
    $("#btnupdate").click(function () {
        ...
        if (UnitName == "") {
            ...
            $.get("../UnitMaster/UpdateData", { _UnitName: UnitName, ID: $("#mUnitMasterId").val() }, function (data) {
                console.log(data);
                document.getElementById("page_settings").reset();
                $("#btnupdate").hide();
                $("#btnsave").show();
...
function GetData() {
    ...
    table.clear().draw();
    $.getJSON("../UnitMaster/getData", function (data) {
        $('#tbl').dataTable({
            "destroy": true,
            "bDestroy": true,
            "bProcessing": true,
...
$(document).on('click', '#Editbtn', function (e) {
    ...
    if (Confm) {
        ...
        $.getJSON("/UnitMaster/getDataWithId", { ID: Ids }, function (data) {
            $.each(data, function (i, item) {
                $("#mUnitMasterId").val(item.mUnitMasterId);
...
$(document).on('click', '#Deletebtn', function (e) {
    ...
    if (answer) {
        $.get("../UnitMaster/DeleteData", { ID: Ids }, function (data) {
            console.log(data);
            GetData();
        });
    }
