...
$(document).ready(function () {
    ...
    $('#TC_InquiryTypeId').kendoComboBox({});
    GetLeadTypes();
    //GetInquiryTypes();
    GetData();
});
...
function GetLeadTypes() {
    $.getJSON("../LeadDispositionMaster/getLeadType", function (data) {
...
function GetInquiryTypes() {
    $.getJSON("../LeadDispositionMaster/getInquiryType", { IDs: $('#TC_LeadTypeId').val() }, function (data) {
        $("#TC_InquiryTypeId").empty("kendoDropDownList");
        $('#TC_InquiryTypeId').kendoComboBox({
...
$(function () {
    ...
    $("#btnsave").click(function () {
        ...
        if (DispositionName == "") {
            ...
            $.get("../LeadDispositionMaster/SaveDisposition", { DispositionName: DispositionName, TC_InquiryTypeId: TC_InquiryTypeIds }, function (data) {
                console.log(data);
                GetData();
            });
        }
    ...
    $("#btnupdate").click(function () {
        ...
        if (DispositionName == "") {
            ...
            $.get("../LeadDispositionMaster/UpdateDisposition", { DispositionName: DispositionName, InqID: INQIds, ID: $("#TC_LeadDispositionId").val() }, function (data) {
                console.log(data);
...
//Get Data
function GetData() {
    $.getJSON("../LeadDispositionMaster/getDisposition", function (data) {
        $('#tbl').dataTable({
            "destroy": true,
            "bDestroy": true,
            "bProcessing": true,
...
$(document).on('click', '#Editbtn', function (e) {
    ...
    if (Confm) {
        $("#btnsave").hide();
        $("#btnupdate").show();
        $.getJSON("/LeadDispositionMaster/getDispositionWithId", { ID: Ids }, function (data) {
...
$(document).on('click', '#Deletebtn', function (e) {
    ...
    if (answer) {
        $.get("../LeadDispositionMaster/DeleteDisposition", { ID: Ids }, function (data) {
            console.log(data);
            GetData();
        });
    }
